/**
 * Per-account ownership guard tests (VAL-AUTH-OWN-001..006)
 *
 * Tests that:
 *   - POST /agent-templates creates template with ownerAccountId = getEffectiveOwnerId(res) (VAL-AUTH-OWN-001)
 *   - PATCH /agent-templates/:id returns 403 if not owner AND not API key listener (VAL-AUTH-OWN-002)
 *   - DELETE /agent-templates/:id returns 403 if not owner AND not API key listener (VAL-AUTH-OWN-003)
 *   - POST /agent-templates/:id/publish returns 403 if not owner AND not API key listener (VAL-AUTH-OWN-004)
 *   - API key listeners can patch/delete/publish any template (VAL-AUTH-OWN-005)
 *   - POST /agent-templates/generate creates template owned by authenticated account (VAL-AUTH-OWN-006)
 */
...
describe("Per-account ownership guards", () => {
  ...
  // VAL-AUTH-OWN-001: POST creates template with ownerAccountId from res.locals.accountId
  ...
  // VAL-AUTH-OWN-002: PATCH returns 403 if not owner AND not API key listener
  ...
  // VAL-AUTH-OWN-003: DELETE returns 403 if not owner AND not API key listener
  ...
  // VAL-AUTH-OWN-004: POST publish returns 403 if not owner AND not API key listener
  ...
  // VAL-AUTH-OWN-005: API key listeners can patch/delete/publish any template
  ...
  // VAL-AUTH-OWN-006: POST /generate creates template owned by authenticated account
