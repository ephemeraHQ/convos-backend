 ...
 *
 * Covers:
 *   Completed jobs have expiresAt set to 24 hours after completion
 *   Pending/in-progress jobs have NULL expiresAt
 *   Expired jobs are not returned by GET endpoint
 *   TTL duration is exactly 24 hours
 *   Expired jobs remain in the database
 *   Multiple jobs with different expiry times
 */
...
describe("CreateJob TTL sweep", () => {
  ...
  // Completed jobs have expiresAt set
