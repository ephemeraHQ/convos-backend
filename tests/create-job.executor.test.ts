...
describe("CreateJob Executor — Happy Path", () => {
  ...
  test("job transitions from pending to generating", async () => {
  ...
  test("job calls templateGen with correct input", async () => {
    installHappyPathMocks();
    const { executeCreateJob } = await import(
      "../src/api/v2/agent-templates/services/job-executor"
    );
  ...
  test("templateGen receives pdfBase64 input", async () => {
    installHappyPathMocks();
    const { executeCreateJob } = await import(
      "../src/api/v2/agent-templates/services/job-executor"
    );
  ...
  test("job transitions from generating to provisioning", async () => {
    installHappyPathMocks();
    const { executeCreateJob } = await import(
      "../src/api/v2/agent-templates/services/job-executor"
    );
  ...
  test("job persists generated template as draft AgentTemplate", async () => {
    installHappyPathMocks();
    const { executeCreateJob } = await import(
      "../src/api/v2/agent-templates/services/job-executor"
    );
  ...
  test("job calls POST /api/assistants with correct payload", async () => {
    installHappyPathMocks();
    const { executeCreateJob } = await import(
      "../src/api/v2/agent-templates/services/job-executor"
    );
  ...
  test("job polls getAssistant until terminal joinStatus", async () => {
    let pollCount = 0;
  ...
  test("job transitions to done when joinStatus is joined", async () => {
    installHappyPathMocks();
    const { executeCreateJob } = await import(
      "../src/api/v2/agent-templates/services/job-executor"
    );
  ...
  test("job transitions to failed when joinStatus is failed", async () => {
    __resetGenerateTemplateForTests((input) => {
      templateGenCalls.push(
        typeof input === "string"
          ? { text: input }
  ...
  test("job transitions to failed when templateGen throws", async () => {
    __resetGenerateTemplateForTests(() => {
  ...
  test("job transitions to failed when ProvisioningClient POST throws", async () => {
    __resetGenerateTemplateForTests((input) => {
      templateGenCalls.push(
        typeof input === "string"
          ? { text: input }
  ...
  test("job transitions to failed when provisioning service is unreachable", async () => {
    __resetGenerateTemplateForTests((input) => {
      templateGenCalls.push(
        typeof input === "string"
          ? { text: input }
  ...
  test("5-minute timeout causes failed state", async () => {
  ...
  test("job sets expiresAt when reaching terminal state (done)", async () => {
    installHappyPathMocks();
    const { executeCreateJob } = await import(
      "../src/api/v2/agent-templates/services/job-executor"
    );
  ...
  test("job sets expiresAt when reaching terminal state (failed)", async () => {
    __resetGenerateTemplateForTests(() => {
  ...
  test("concurrent jobs execute independently", async () => {
  ...
  test("job follows strict state machine order", async () => {
    installHappyPathMocks();
    const { executeCreateJob } = await import(
      "../src/api/v2/agent-templates/services/job-executor"
    );
  ...
  test("job can transition from generating to failed (templateGen error)", async () => {
    __resetGenerateTemplateForTests(() => {
  ...
  test("job can transition from provisioning to failed (provisioning POST error)", async () => {
    __resetGenerateTemplateForTests((input) => {
      templateGenCalls.push(
        typeof input === "string"
          ? { text: input }
  ...
  test("generated template uses ADMIN_ACCOUNT_ID as owner", async () => {
    installHappyPathMocks();
    const { executeCreateJob } = await import(
      "../src/api/v2/agent-templates/services/job-executor"
    );
  ...
  test("background job uses the joinUrl from the original request", async () => {
    installHappyPathMocks();
    const { executeCreateJob } = await import(
      "../src/api/v2/agent-templates/services/job-executor"
    );
