...
describe("CreateJob PostHog Metering", () => {
  test("successful job generation emits builder.template.generated event", async () => {
  ...
  test("event includes source: create-job property", async () => {
    installHappyPathMocks();
    const { executeCreateJob } = await import(
      "../src/api/v2/agent-templates/services/job-executor"
    );
  ...
  test("event includes the ownerAccountId", async () => {
    installHappyPathMocks();
    const { executeCreateJob } = await import(
      "../src/api/v2/agent-templates/services/job-executor"
    );
  ...
  test("event is not emitted for failed generations", async () => {
  ...
  test("event includes inputType property for text input", async () => {
    installHappyPathMocks();
    const { executeCreateJob } = await import(
      "../src/api/v2/agent-templates/services/job-executor"
    );
  ...
  test("event includes inputType property for pdfBase64 input", async () => {
    installHappyPathMocks();
    const { executeCreateJob } = await import(
      "../src/api/v2/agent-templates/services/job-executor"
    );
  ...
  test("event includes inputType property for imageBase64 input", async () => {
    installHappyPathMocks();
    const { executeCreateJob } = await import(
      "../src/api/v2/agent-templates/services/job-executor"
    );
  ...
  test("event uses the existing PostHog service at posthog.ts", () => {
  ...
  test("event is emitted exactly once per successful job", async () => {
    installHappyPathMocks();
    const { executeCreateJob } = await import(
      "../src/api/v2/agent-templates/services/job-executor"
    );
