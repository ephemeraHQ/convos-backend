 ...
 *
 * Validates VAL-TB-MOD-001 through VAL-TB-MOD-006:
...
// ===========================================================================
// VAL-TB-MOD-001: Returns { allowed: true } for safe, agent-request content
// ===========================================================================

describe("twitterModeration — safe agent requests (VAL-TB-MOD-001)", () => {
...
// ===========================================================================
// VAL-TB-MOD-002: Returns { allowed: false, reason: "blocked" } for unsafe content
// ===========================================================================

describe("twitterModeration — unsafe content (VAL-TB-MOD-002)", () => {
...
// ===========================================================================
// VAL-TB-MOD-003: Returns { allowed: false, reason: "not_agent_request" }
//                 for non-agent-request content
// ===========================================================================

describe("twitterModeration — non-agent-request content (VAL-TB-MOD-003)", () => {
...
// ===========================================================================
// VAL-TB-MOD-004: Fails open — returns { allowed: true } on OpenRouter errors
// ===========================================================================

describe("twitterModeration — fail-open on errors (VAL-TB-MOD-004)", () => {
...
// ===========================================================================
// VAL-TB-MOD-005: Completes in under 5 seconds for typical inputs
// ===========================================================================

describe("twitterModeration — performance (VAL-TB-MOD-005)", () => {
...
// ===========================================================================
// VAL-TB-MOD-006: Uses BUILDER_OPENROUTER_API_KEY
// ===========================================================================

describe("twitterModeration — API key (VAL-TB-MOD-006)", () => {
