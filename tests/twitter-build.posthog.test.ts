...
describe("Twitter Build PostHog Metering", () => {
  // PostHog event fires with source="twitter" for twitter builds
  test("PostHog fires with source='twitter' for twitter builds", async () => {
  ...
  // PostHog event fires with source="create-job" for app/web builds
  test("PostHog fires with source='create-job' for app source builds", async () => {
