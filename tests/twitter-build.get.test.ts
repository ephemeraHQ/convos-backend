 ...
 *
 * Covers:
 *   GET returns twitter-specific result (templateId, slug, templateUrl, replyText)
 *   GET for twitter source does NOT include instance fields
 *   GET works identically for all sources (same polling, wait_ms)
 *   GET for twitter source returns 404 for expired jobs
 */
...
describe("GET /api/v2/agent-templates/create-job/:jobId — twitter source", () => {
  ...
  // GET returns twitter-specific result fields
  ...
  // GET works identically for all sources (same polling)
