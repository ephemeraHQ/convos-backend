...
// ---------------------------------------------------------------------------
// Uses Bearer token from PROVISIONING_API_KEY
// ---------------------------------------------------------------------------

describe("ProvisioningClient — Bearer auth", () => {
...
// ---------------------------------------------------------------------------
// createAssistant sends correct POST body shape
// ---------------------------------------------------------------------------

describe("ProvisioningClient — POST body shape", () => {
...
// ---------------------------------------------------------------------------
// createAssistant returns { instanceId } on 200
// ---------------------------------------------------------------------------

describe("ProvisioningClient — returns instanceId", () => {
...
// ---------------------------------------------------------------------------
// getAssistant returns full status object
// ---------------------------------------------------------------------------

describe("ProvisioningClient — getAssistant returns full status", () => {
...
// ---------------------------------------------------------------------------
// Throws on non-2xx responses with status and body
// ---------------------------------------------------------------------------

describe("ProvisioningClient — non-2xx error handling", () => {
...
describe("ProvisioningClient — configurable base URL", () => {
...
describe("ProvisioningClient — network error handling", () => {
